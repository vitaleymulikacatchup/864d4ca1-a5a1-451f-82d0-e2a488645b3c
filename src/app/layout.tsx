...
export const metadata: Metadata = {
  title: "Luxe Hotel - Luxury Accommodations & Premium Services",
  description: "Experience luxury and comfort at Luxe Hotel. Book your stay and enjoy world-class amenities, fine dining, spa services, and exceptional hospitality.",
  keywords: "luxury hotel, accommodations, rooms, suites, hospitality, spa, dining, resort",
  metadataBase: new URL("https://luxehotel.com"),
  alternates: {
    canonical: "https://luxehotel.com"
  },
  openGraph: {
    title: "Luxe Hotel - Your Perfect Escape Awaits",
    description: "Discover unforgettable luxury at Luxe Hotel with elegant rooms, premium amenities, and exceptional service.",
    type: "website",
    siteName: "Luxe Hotel",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763889436838-2twzhkwj.jpg",
      alt: "Luxury Hotel Lobby"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Luxe Hotel - Premium Accommodations",
    description: "Experience luxury at Luxe Hotel with world-class amenities and exceptional service.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32m5rRdd38TAyU0DZCqvrl288SF/uploaded-1763889436838-2twzhkwj.jpg"]
  },
  robots: {
    index: true,
    follow: true
